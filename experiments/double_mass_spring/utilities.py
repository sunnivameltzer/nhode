...
class Params(eqx.Module):
    ...
    L0: float; L1: float   # rest lengths of the springs
...
def to_canonical(ys, m0, m1):
    x0, x1, v0, v1 = ys[..., 0], ys[..., 1], ys[..., 2], ys[..., 3]
    p0, p1 = m0 * v0, m1 * v1
    return jnp.stack([x0, x1, p0, p1], axis=-1) 
...
def load_model(
    ...
    if aux_like is not None:
        ...
        system_params = aux["system_params"]
        return model, system_params

...
def train_partially_observed(
    ...
    # Observed state indices for triangular system (masses 0 and 1)
    # State layout: [qx0,qy0,qx1,qy1,qx2,qy2, px0,py0,px1,py1,px2,py2]
    # Observe: [qx0,qy0,qx1,qy1, px0,py0,px1,py1] = indices [0,1,2,3,6,7,8,9]
    OBSERVED_INDICES = jnp.array([0, 1, 2, 3, 6, 7, 8, 9])
